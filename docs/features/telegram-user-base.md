...
Закрыто как не нужное для дальнейшей проработки в рамках текущего плана. Бэкенд и тесты готовы; исходный фронтовый follow-up по спецификации 001 оставлен без изменений по подтверждению пользователя.
