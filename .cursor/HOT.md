...
## recent_completed
1. `actor-cast-profile-stats` — closed 2026-08-07T232200Z
   - Feature: `.cursor/features/actor-cast-profile-stats/feature.md`
   - Active: `.cursor/active/actor-cast-profile-stats/`
   - Docs: `docs/features/actor-cast-profile-stats.md`
2. `profile-streak-stats-legend-ux` — closed 2026-08-07T212500Z
   - Feature: `.cursor/features/profile-streak-stats-legend-ux/feature.md`
   - Active: `.cursor/active/profile-streak-stats-legend-ux/`
   - Docs: `docs/features/profile-streak-stats-legend-ux.md`
3. `backend-test-unit-integration-split` — closed 2026-08-04T111000Z
