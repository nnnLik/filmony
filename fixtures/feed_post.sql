...
) AS v(id, user_id, body, image_url, referenced_card_idx, source_comment_idx, created_at)
LEFT JOIN card_map AS cm ON cm.idx = v.referenced_card_idx
LEFT JOIN comment_map AS ccm ON ccm.idx = v.source_comment_idx
ON CONFLICT (id) DO UPDATE SET
  user_id = EXCLUDED.user_id,
  body = EXCLUDED.body,
  image_url = EXCLUDED.image_url,
  referenced_card_id = EXCLUDED.referenced_card_id,
